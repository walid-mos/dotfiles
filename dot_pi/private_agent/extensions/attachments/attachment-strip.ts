...
const ITERM_IMAGE_START = '\x1b]1337;'
...
function renderPreview(
	...
	// Pi 0.85.1's column parser otherwise consumes the cursor-up plus OSC as one
	// escape, exposing/truncating base64. Separate them without changing placement.
	return rows.map(line =>
		line.replace(ITERM_IMAGE_START, SGR_RESET + ITERM_IMAGE_START),
	)
}
