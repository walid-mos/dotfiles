/**
 * lazy-tools - pay for a tool's schema only once the session asks for it.
 *
 ...
 *
 * Config: `<agentDir>/lazy-tools.json`, optional, read once per session:
 *   {
...
const CONFIG_FILE = 'lazy-tools.json'
