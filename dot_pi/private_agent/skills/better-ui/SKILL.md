---
name: better-ui
description: Polishes and improves the UI in your project, and applies these rules to any UI you generate from scratch. Covers concentric border radius, optical alignment, surface depth, contextual icons, hit areas and more. Use when generating or polishing any UI. For the visual-design philosophy behind it, see emil-design-eng.
---
