...
description: Encodes Emil Kowalski's philosophy on UI polish, component design, animation decisions, and the invisible details that make software feel great. Use when generating any UI, designing components or animations, or reviewing UI for taste and feel. Pairs with better-ui for exact values and recipes.
---
