...
**Mechanical caps** (thresholds in the Mechanical Caps section of `SKILL.md`): import count, complexity, nesting, file size. A cap firing near these failure modes means the architectural question below must be answered - these rules are the answer, not the threshold.

---

## Deep Modules Over Shallow (HIGHEST PRIORITY)
...
## Typed Structures Over Positional Data
