...
void test('single-select digit targeting the custom row focuses the editor', () => {
	const q = question('q1')
...
void test('multi-select digit targeting the custom row focuses the editor', () => {
...
void test('multi-select commit includes live custom text after leaving the editor', () => {
	const q = question('q1', { multiSelect: true })
...
void test('collected answers follow questionnaire order after tab navigation', () => {
