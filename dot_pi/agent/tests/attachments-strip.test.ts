...
import { renderAttachmentStrip } from '../extensions/attachments/attachment-strip.ts'
import { toImageAlias } from '../extensions/attachments/image-paths.ts'
...
import type { StripFrame } from '../extensions/attachments/attachment-strip.ts'
import type { PromptCapture } from '../extensions/attachments/image-paths.ts'
import type { PreviewSource } from '../extensions/attachments/preview-service.ts'
