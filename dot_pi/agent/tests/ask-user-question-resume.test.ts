...
void test('single option resumes by stable value after labels and positions change', () => {
...
void test('multi-select resume rebuilds selections and current labels', () => {
...
void test('incompatible persisted answers are ignored', () => {
	const initial: QuestionnaireInitialState = {
		answers: [
			{
				kind: 'single',
